class Users::OmniauthCallbacksController < Devise::OmniauthCallbacksController
  ...
  def foursquare
    ...
    if @user.persisted?
      ...
      flash[:notice] = raw("Your Foursquare account has been successfully connected! Now check the <a href='/campaigns'>campaigns page</a> to learn where to use.")
  ...
  def instagram
    ...
    if @user.persisted?
      sign_in @user, :event => :authentication
      flash[:notice] = raw("Your Instagram account has been successfully connected! Now check the <a href='/campaigns'>campaigns page</a> to learn where to use.")
